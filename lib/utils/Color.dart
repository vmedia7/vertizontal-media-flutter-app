/// Small Utility to create a [Color] from [hexString]
...
extension HexColor on Color {
  /// Takes a [hexString] and convert it to a 8 length buffer 
  /// FFRRGGBB then parses it.
  static Color fromHex(String hexString) {
    final buffer = StringBuffer();
    hexString = hexString.replaceFirst('#', '');

    /* Converting the [hexString] into a 8 length buffer */
